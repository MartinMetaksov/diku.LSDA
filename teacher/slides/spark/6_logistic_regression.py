# Adapted from https://github.com/apache/spark/blob/master/examples/src/main/python/logistic_regression.py
#
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 4:
        print("Usage: logistic_regression <file> <dim> <iterations>", file=sys.stderr)
        exit(-1)
